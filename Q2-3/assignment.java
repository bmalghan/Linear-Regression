...
public class assignment {
 ...
 private static void randomDimension(int dimension){
  ...
  // your code goes there
      LinearRegression linearRegression2 = new LinearRegression(dimension,5000);
      ...
      for(int i=0; i<dimension; i++){
          y[i] = generator.nextDouble()*200-100;
      }
      ...
      for(int i=0; i<5000; i++){
          ...
          double w = generator.nextDouble()*40-20;
          double e = y[0]+sum+w;
          linearRegression2.addSample(x,e);
    ...
    for(int i=0; i<20; i++){
      System.out.println("Current Hypothesis: " + linearRegression2.currentHypothesis());
      System.out.println("Current Cost: " + linearRegression2.currentCost());
      System.out.println ("Aiming For: "+aim+(y[dimension-1]+"x_"+dimension));
      linearRegression2.gradientDescent(0.0000000008,100);
    }
